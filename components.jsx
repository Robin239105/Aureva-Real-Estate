    ...
    <header className={`header ${solid ? 'solid' : 'transparent'}`}>
      ...
      <div
        ...
        style={{
          ...
          padding: solid ? '16px 40px' : '22px 40px',
      ...
      {menuOpen && (
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Logo tone="ivory" />
            <button onClick={() => setMenuOpen(false)} style={{ color: 'var(--ivory)' }}>
              <Icon.Close />
            </button>
          </div>
      ...
      <div className="container">
        ...
        >
          <div>
            ...
            >
              Aureva Estates · A boutique brokerage representing the world's most considered
              residences.
            </p>
          </div>

          <div>
            <h4 className="eyebrow on-dark" style={{ marginBottom: 22 }}>
              Navigate
            </h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: 12 }}>
              {['home', 'properties', 'buy', 'rent', 'sell'].map((id) => (
                <li key={id}>
                  <a onClick={() => navigate(id)} style={{ cursor: 'pointer' }}>
                    {NAV_LINKS.find((n) => n.id === id).label}
                  </a>
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: 12 }}>
              ...
              <li>
                <a style={{ cursor: 'pointer' }}>Press</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form
              ...
              style={{ display: 'flex', gap: 0, borderBottom: '1px solid rgba(201,164,92,0.4)' }}
            >
              <input
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 22, flexWrap: 'wrap' }}>
            ...
            <a onClick={() => navigate('accessibility')} style={{ cursor: 'pointer' }}>
              Accessibility
            </a>
            <a onClick={() => navigate('cookies')} style={{ cursor: 'pointer' }}>
              Cookies
            </a>
          </div>
          <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
            ...
            <a href="#" aria-label="LinkedIn" style={{ display: 'inline-flex' }}>
              <FaLinkedin size={16} />
            </a>
            <a href="#" aria-label="Pinterest" style={{ display: 'inline-flex' }}>
              <FaPinterest size={16} />
            </a>
            ...
            <a href="#" aria-label="YouTube" style={{ display: 'inline-flex' }}>
              <FaYoutube size={16} />
            </a>
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className="img-wrap img-zoom">
        ...
        <div
          style={{ position: 'absolute', top: 14, left: 14, display: 'flex', gap: 6, zIndex: 2 }}
        >
      ...
      <div className="body">
        ...
        <div className="specs spec-row">
          <span>
            <Icon.Bed /> {p.beds} Beds
          </span>
          <span className="spec-divider"></span>
          <span>
            <Icon.Bath /> {p.baths} Baths
          </span>
          <span className="spec-divider"></span>
          <span>
            <Icon.Area /> {p.area.toLocaleString()} ft²
          </span>
        </div>
      </div>
    </article>
    ...
    >
      <div
        style={{
          ...
          gap: 0,
          padding: '0 0',
          borderBottom: isDark ? '1px solid rgba(201,164,92,0.18)' : '1px solid var(--line)',
        }}
      >
        {['buy', 'rent', 'sell'].map((t) => (
          <button
      ...
      >
        ...
        <SearchField
          ...
          placeholder="Any"
          select
          options={['Any', 'Villa', 'Penthouse', 'Apartment', 'Loft', 'Estate', 'Cottage']}
        ></SearchField>
        <SearchField
          isDark={isDark}
          label="Price Range"
          placeholder="Any"
          select
          options={['Any', '< $1M', '$1M – $5M', '$5M – $15M', '$15M+']}
        ></SearchField>
        <SearchField
          isDark={isDark}
          label="Bedrooms"
    ...
    >
      <div
        style={{
          ...
          letterSpacing: '0.2em',
          textTransform: 'uppercase',
          color: isDark ? 'rgba(248,245,239,0.55)' : 'var(--slate)',
          marginBottom: 6,
          fontWeight: 500,
        }}
      >
      ...
      <div
        style={{
          ...
          alignItems: 'center',
          gap: 8,
          color: isDark ? 'var(--gold)' : 'var(--gold-deep)',
        }}
      >
        {children}
        {select ? (
  ...
  return (
    ...
    >
      <div style={{ textAlign: align, maxWidth: 700 }}>
        {eyebrow && (
          <div className={`eyebrow ${onDark ? 'on-dark' : ''}`} style={{ marginBottom: 14 }}>
            {eyebrow}
          </div>
        )}
        <h2
          ...
          style={{
            ...
            fontWeight: 400,
            lineHeight: 1.05,
            color: onDark ? 'var(--ivory)' : 'var(--navy)',
            margin: 0,
        ...
        {kicker && (
          <p
            style={{
              fontSize: 16,
              lineHeight: 1.7,
              color: onDark ? 'rgba(248,245,239,0.7)' : 'var(--slate)',
              marginTop: 18,
              maxWidth: 560,
            }}
          >
  ...
  return (
    ...
    >
      ...
      <div className="container-narrow" style={{ position: 'relative', textAlign: 'center' }}>
        ...
        >
          Find spaces that feel
          <br />
          <em style={{ color: 'var(--gold)', fontWeight: 400 }}>like success.</em>
        </h2>
        <p
          style={{
            fontSize: 17,
        ...
        >
          From private listings to seamless transactions — work with an Aureva advisor who knows the
          residences before they reach the market.
        </p>
        <div
          style={{
            display: 'inline-flex',
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18, flexWrap: 'wrap' }}>
        <div style={{ flex: '1 1 320px', minWidth: 0 }}>
          ...
          <p style={{ margin: 0, fontSize: 14, lineHeight: 1.65, color: 'rgba(248,245,239,0.85)' }}>
            We use cookies to enable core site functions, measure traffic, and improve your
            experience. Read our{' '}
            <a
              onClick={() => {
                setVisible(false);
          ...
          {[
            {
              ...
              desc: 'Required for core functions (favorites, consent). Always on.',
              locked: true,
            },
            {
              k: 'analytics',
            ...
            >
              ...
              />
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--ivory)' }}>
                  {c.label}
                </div>
                <div
                  style={{
