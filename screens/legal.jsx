        ...
        <div className="container-narrow" style={{ maxWidth: 820 }}>
          {updated && (
            <div className="mono" style={{
              ...
              color: "var(--slate)", marginBottom: 40, paddingBottom: 20,
          ...
          <div className="legal-body" style={{
            fontFamily: "var(--sans)", fontSize: 15.5, lineHeight: 1.8, color: "var(--charcoal)",
          }}>
            {children}
          </div>
        </div>
...
function PrivacyPage({ navigate }) {
  return (
    ...
    >
      ...
      <p>Aureva Estates ("Aureva", "we", "us", or "our") respects your privacy and is committed to protecting your personal data. This Privacy Policy explains how we collect, use, store, and disclose information about you when you visit our website, contact our advisors, or engage our services.</p>
      <p>By using our website you consent to the practices described in this policy. If you do not agree, please discontinue use of the site.</p>

      <h2>2. Information we collect</h2>
      <h3>Information you provide</h3>
      <ul>
        <li><strong>Contact details</strong> — name, email address, phone number, mailing address.</li>
        <li><strong>Property preferences</strong> — search criteria, saved favorites, budget range, intended use.</li>
        <li><strong>Transaction information</strong> — when you list a property or make an offer through Aureva.</li>
        <li><strong>Communications</strong> — messages you send to our advisors via forms, email, or phone.</li>
      </ul>
      ...
      <ul>
        ...
        <li>To send marketing communications (only with your consent — you can opt out anytime).</li>
      ...
      <p>We process personal data on the following legal bases: your <strong>consent</strong>, the necessity to <strong>perform a contract</strong> with you, our <strong>legitimate interests</strong> (improving services, fraud prevention), and <strong>compliance with legal obligations</strong>.</p>
      ...
      <ul>
        ...
        <li>Service providers (hosting, analytics, email delivery, escrow) under written confidentiality agreements.</li>
      ...
      <p>We retain personal data only as long as necessary for the purposes set out in this policy, or as required by law (typically 7 years for transaction records).</p>
      ...
      <h2>10. Children</h2>
      <p>Our services are not directed to persons under 18. We do not knowingly collect data from minors.</p>

      <h2>11. Updates</h2>
      <p>We may update this policy from time to time. The "Last updated" date above reflects the most recent revision. Material changes will be notified via the website or email.</p>
...
function TermsPage({ navigate }) {
  return (
    ...
    >
      ...
      <h2>3. Services</h2>
      <p>Aureva is a licensed real estate brokerage. Listings, pricing, and property information shown on the Site are provided for informational purposes and are subject to change without notice. All measurements, prices, and amenities should be independently verified.</p>
      <p>Aureva makes no warranty as to the accuracy of third-party listing data, images, or descriptions.</p>

      <h2>4. No advice</h2>
      <p>Nothing on the Site constitutes legal, tax, financial, or investment advice. Consult qualified professionals before making any real estate decision.</p>
      ...
      <ul>
        ...
        <li>Interfere with the operation of the Site, attempt to gain unauthorized access, or introduce malware.</li>
        <li>Impersonate any person or misrepresent affiliation.</li>
        <li>Use the Site to send unsolicited communications.</li>
      </ul>

      <h2>6. Intellectual property</h2>
      <p>All content on the Site — including the Aureva mark, logo, design, photography, copy, and code — is owned by Aureva Estates or its licensors and protected by copyright, trademark, and other laws. You may not reproduce, distribute, or create derivative works without our prior written consent.</p>

      <h2>7. User-submitted content</h2>
      <p>By submitting any information through forms (contact, sell, newsletter) you grant Aureva a non-exclusive, royalty-free license to use that information to provide services and to communicate with you.</p>

      <h2>8. Third-party links</h2>
      <p>The Site may link to third-party websites. Aureva is not responsible for the content, policies, or practices of any third-party site.</p>

      <h2>9. Disclaimer</h2>
      <p>The Site is provided "as is" and "as available" without warranty of any kind. To the maximum extent permitted by law, Aureva disclaims all warranties, express or implied, including merchantability, fitness for a particular purpose, and non-infringement.</p>

      <h2>10. Limitation of liability</h2>
      <p>To the maximum extent permitted by law, Aureva shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Site. Our total liability under these Terms shall not exceed one hundred U.S. dollars ($100).</p>

      <h2>11. Indemnification</h2>
      <p>You agree to indemnify and hold harmless Aureva, its officers, employees, and advisors from any claim arising out of your use of the Site or breach of these Terms.</p>

      <h2>12. Governing law</h2>
      <p>These Terms are governed by the laws of the State of New York, without regard to conflict-of-law principles. Exclusive jurisdiction and venue lie in the state and federal courts located in New York County, New York.</p>
...
function AccessibilityPage({ navigate }) {
  return (
    ...
    >
      ...
      <p>Aureva Estates is committed to ensuring digital accessibility for people with disabilities. We continually improve the user experience for everyone and apply the relevant accessibility standards.</p>
      ...
      <ul>
        ...
        <li>Respect for the <code>prefers-reduced-motion</code> media query — animations are minimized when requested.</li>
      ...
      <ul>
        ...
        <li>The hero carousel auto-rotates; pausing on hover is supported, but a manual pause control will be added in a future release.</li>
        <li>Property floor-plan SVGs do not currently include text descriptions of room layouts.</li>
      </ul>
...
function CookiesPage({ navigate }) {
  const reset = () => {
    try { localStorage.removeItem("aureva_cookie_consent"); } catch (e) {}
  ...
  return (
    ...
    >
      ...
      <p>Cookies are small text files stored on your device when you visit a website. They allow the site to remember your preferences, keep you signed in, and understand how you use the site.</p>

      <h2>Categories we use</h2>
      <table>
        <thead>
          <tr><th>Category</th><th>Purpose</th><th>Examples</th><th>Required</th></tr>
        </thead>
        <tbody>
          <tr>
            <td><strong>Strictly necessary</strong></td>
            <td>Enable core functionality such as saving favorites and remembering your cookie choice.</td>
            <td><code>aureva_favs</code>, <code>aureva_cookie_consent</code></td>
            <td>Yes</td>
          </tr>
          <tr>
      ...
      <ul>
        <li><strong>Google Fonts</strong> — to deliver typography. Does not set tracking cookies.</li>
        <li><strong>Unsplash</strong> — image CDN. Does not set tracking cookies.</li>
      </ul>
      <p>If we add analytics or advertising tags in the future, they will be listed here and disabled by default until you opt in.</p>

      <h2>Managing cookies</h2>
      <p>You can accept, reject, or revisit your choice at any time using the controls below or your browser settings.</p>
      <p>
        <button className="btn btn-navy" onClick={reset}>Reset cookie preferences <span className="arrow"></span></button>
      </p>
      <p>To manage cookies at the browser level: <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer">Chrome</a> · <a href="https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer" target="_blank" rel="noopener noreferrer">Firefox</a> · <a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer">Safari</a> · <a href="https://support.microsoft.com/en-us/windows/manage-cookies-in-microsoft-edge-168dab11-0753-043d-7c16-ede5947fc64d" target="_blank" rel="noopener noreferrer">Edge</a>.</p>
