  ...
  return (
    <div className="page">
          ...
          >
            <Reveal>
              ...
              >
                ...
                to buy, sell,
                <br />
                <em style={{ color: 'var(--gold)' }}>and belong.</em>
              </h2>
              <p
                style={{
                  fontSize: 16,
              ...
              >
                We are a small house of advisors representing fewer clients, more deeply. Every
                listing is curated; every introduction, deliberate.
              </p>
              <div
                style={{
                  display: 'grid',
            ...
            <Reveal delay={150}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                {[
                  {
                    t: 'Discreet representation',
                    d: 'Pocket listings, private showings, and confidential transactions for clients who require it.',
                  },
                  {
                    t: 'World-class marketing',
                    d: 'Editorial-grade photography, film, and placement across global luxury press.',
                  },
                  {
                    t: 'Concierge from offer to keys',
                    d: 'Legal, inspection, financing, design — coordinated through a single advisor.',
                  },
                  {
                    t: 'Global reach, local depth',
                    d: 'A boutique footprint in 38 markets and an exchange network across 12 countries.',
                  },
                ].map((f, i) => (
                  <div
                    key={f.t}
                  ...
                  >
                    <div
                      className="serif"
                      style={{ fontSize: 28, color: 'var(--gold)', fontWeight: 400 }}
                    >
                      0{i + 1}
                    </div>
                    <h4
      ...
      <section style={{ background: 'var(--ivory)' }}>
        <div
          style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', minHeight: 720 }}
        ...
        >
          ...
          >
            <Reveal>
              ...
              <h2
                className="serif underline-gold"
                style={{
              ...
              >
                Full-floor sky residence above Tribeca. Six exposures, private elevator, 1,800 ft²
                of wraparound terrace. A rare moment of pause above the city.
              </p>
              <div
                style={{
                  display: 'grid',
              ...
              >
                {[
                  ...
                  <div key={l}>
                    <div
                      className="serif"
                      style={{ fontSize: 24, fontWeight: 500, color: 'var(--navy)' }}
                    >
                      {n}
                    </div>
                    <div
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '22px 22px 26px' }}>
        ...
        <div style={{ fontSize: 12, color: 'var(--slate)', letterSpacing: '0.06em', marginTop: 6 }}>
          {a.title}
        </div>
        <div
          style={{
...
function TestimonialRotator() {
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 40 }}>
        <div className="serif" style={{ fontSize: 18, color: 'var(--navy)', fontWeight: 500 }}>
          {t.name}
        </div>
        <div
          style={{
  ...
  return (
    <article onClick={onOpen} className="card" style={{ cursor: 'pointer', background: '#fff' }}>
      ...
      <div style={{ padding: '26px 26px 30px' }}>
        ...
        <div
          style={{ marginTop: 22, fontSize: 12, color: 'var(--charcoal)', letterSpacing: '0.06em' }}
        >
          {b.date}
        </div>
      </div>
...
const HERO_SLIDES = [
  ...
  {
    img: IMG.penthouse,
    label: 'The Sterling Penthouse',
    city: 'Tribeca, Manhattan',
    price: '$8.20M',
    id: 'p02',
  },
  {
    img: IMG.beach,
    label: 'Ocean House Malibu',
    city: 'Malibu Colony',
    price: '$18.90M',
    id: 'p03',
  },
  {
    img: IMG.estate,
    label: 'Maple Ridge Estate',
    city: 'Aspen Highlands',
    price: '$6.75M',
    id: 'p04',
  },
];
    ...
    >
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                'linear-gradient(100deg, rgba(11,18,32,0.95) 0%, rgba(11,18,32,0.85) 38%, rgba(11,18,32,0.55) 62%, rgba(11,18,32,0.78) 100%)',
            }}
          />
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                'radial-gradient(ellipse 60% 70% at 28% 50%, rgba(0,0,0,0.55), transparent 70%)',
            }}
          />
      ...
      <div
        ...
        style={{
          ...
          width: 1,
          background:
            'linear-gradient(180deg, transparent, rgba(201,164,92,0.45) 30%, rgba(201,164,92,0.45) 70%, transparent)',
          zIndex: 2,
          pointerEvents: 'none',
      ...
      >
        <div
          className="container-wide hero-ticker"
          style={{
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'space-between',
        ...
        >
          ...
          <div
            className="ticker-stats"
            style={{ display: 'flex', gap: 28, color: 'rgba(248,245,239,0.6)' }}
          >
            <span>
              <span style={{ color: 'var(--gold)' }}>$4.2B</span>&nbsp; Sold YTD
            </span>
            <span>
              <span style={{ color: 'var(--gold)' }}>1,400+</span>&nbsp; Residences
            </span>
            <span>
              <span style={{ color: 'var(--gold)' }}>7</span>&nbsp; New this week
            </span>
          </div>
        </div>
      </div>
      ...
      {/* === Main hero content === */}
      <div
        className="container-wide hero-grid"
        style={{
          position: 'relative',
          zIndex: 3,
      ...
      >
        ...
        <div style={{ minWidth: 0 }}>
          ...
          >
            A curated collection of the world's most considered residences — represented by advisors
            who treat your move as their craft.
          </p>
          ...
          <div
            style={{
              ...
              marginTop: 32,
              flexWrap: 'wrap',
              animation: 'fadeUp 800ms 1700ms both',
            }}
          >
          ...
          <div
            ...
            style={{
              ...
              animation: 'fadeUp 800ms 1900ms both',
          ...
          >
            {[
              ...
              <div key={i}>
                ...
                >
                  {s.prefix}
                  <Counter target={s.n} duration={1800} delay={2100 + i * 180} />
                  {s.suffix}
                </div>
                <div
                  style={{
        ...
        <div
          ...
          style={{
            ...
            minHeight: 380,
            animation: 'fadeUp 900ms 800ms both',
            minWidth: 0,
          }}
        >
          <div
          ...
          >
            <span
              style={{ display: 'inline-block', width: 28, height: 1, background: 'var(--gold)' }}
            ></span>
            Now showing
          </div>
                ...
                >
                  <div
                    style={{
                      ...
                      boxShadow:
                        offset === 0
                          ? '0 30px 80px rgba(0,0,0,0.55), 0 0 0 1px rgba(201,164,92,0.25), 0 0 60px rgba(201,164,92,0.15)'
                          : 'none',
                    }}
                  >
                    <div
...
function Counter({ target, duration = 1500, delay = 0 }) {
  ...
  const display =
    target >= 1000 ? Math.round(val).toLocaleString() : isInt ? Math.round(val) : val.toFixed(1);
