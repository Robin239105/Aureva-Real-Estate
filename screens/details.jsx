  ...
  return (
    <div className="page" style={{ background: 'var(--ivory)' }}>
            ...
            <div style={{ display: 'flex', gap: 14 }}>
              <button
                ...
                style={{
                  ...
                  letterSpacing: '0.14em',
                  textTransform: 'uppercase',
                  color: favs.includes(p.id) ? 'var(--gold-deep)' : 'var(--slate)',
                }}
              >
      ...
      <section style={{ padding: '30px 0 60px' }}>
        <div className="container-wide">
          <div
            style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: 60 }}
          ...
          >
            <div>
              ...
              <div className="spec-row" style={{ marginTop: 20 }}>
                <span>
                  <Icon.Bed /> {p.beds} Bedrooms
                </span>
                <span className="spec-divider"></span>
                <span>
                  <Icon.Bath /> {p.baths} Bathrooms
                </span>
                <span className="spec-divider"></span>
                <span>
            ...
            <div>
              ...
              <div>
                <h2
                  ...
                  style={{ fontSize: 32, fontWeight: 500, color: 'var(--navy)', margin: 0 }}
                >
                  About this residence
                </h2>
                <p
                  style={{ fontSize: 17, lineHeight: 1.8, color: 'var(--charcoal)', marginTop: 28 }}
                >
                  {p.description}
                </p>
                <p style={{ fontSize: 17, lineHeight: 1.8, color: 'var(--charcoal)' }}>
                  Built in {p.yearBuilt}, this {p.type.toLowerCase()} balances editorial restraint
                  with quiet ambition — a residence designed for the rituals of an examined life.
                  Soft north light through the principal rooms, generous proportions throughout, and
                  a thoughtful sequence from public to private quarters.
                </p>
              </div>
            ...
            <aside style={{ position: 'relative' }}>
              <div style={{ position: 'sticky', top: 110, display: 'grid', gap: 20 }}>
                <div className="card" style={{ padding: 28, background: '#fff' }}>
                  ...
                  <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
                    ...
                    <div>
                      <div
                        className="serif"
                        style={{ fontSize: 22, fontWeight: 500, color: 'var(--navy)' }}
                      >
                        {agent.name}
                      </div>
                  ...
                  <button
                    onClick={() => navigate('agent', { id: agent.id })}
                ...
                >
                  ...
                  <h3
                    className="serif"
                    style={{ fontSize: 26, fontWeight: 500, margin: 0, letterSpacing: '-0.01em' }}
                  >
                    Private tour
                  </h3>
                  {submitted ? (
                    ...
                    >
                      <div
                        style={{ color: 'var(--gold)', display: 'inline-flex', margin: '0 0 12px' }}
                      >
                        <Icon.Check />
                      </div>
                      <p
                      ...
                      <p style={{ fontSize: 13, color: 'rgba(248,245,239,0.6)', marginTop: 6 }}>
                        Your advisor will confirm within the hour.
                      </p>
                    </div>
                  ) : (
                    <form
                    ...
                    >
                      ...
                      <select className="input dark-field" defaultValue="">
                        ...
                        <option value="in-person" style={{ color: '#0B1220', background: '#fff' }}>
                          In-person tour
                        </option>
                        <option value="video" style={{ color: '#0B1220', background: '#fff' }}>
                          Private video tour
                        </option>
                        <option value="info" style={{ color: '#0B1220', background: '#fff' }}>
                          Just send more information
                        </option>
                      </select>
      ...
      {lightbox && (
        ...
        >
          <button
            onClick={() => setLightbox(false)}
            style={{ position: 'absolute', top: 30, right: 30, color: 'var(--ivory)' }}
          >
            <Icon.Close />
          </button>
          <button
            onClick={(e) => {
              e.stopPropagation();
              setActiveImage((activeImage - 1 + p.gallery.length) % p.gallery.length);
            }}
            style={{
              position: 'absolute',
              left: 30,
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              setActiveImage((activeImage + 1) % p.gallery.length);
            }}
            style={{
              position: 'absolute',
              right: 30,
  ...
  return (
    <svg viewBox="0 0 800 360" style={{ width: '100%', height: 320, display: 'block' }}>
      ...
      <g fontFamily="JetBrains Mono, monospace" fontSize="10" fill="#64748B">
        ...
        <text x="660" y="120" textAnchor="middle">
          KITCHEN
        </text>
        ...
        <text x="460" y="240" textAnchor="middle">
          M. SUITE
        </text>
        <text x="660" y="280" textAnchor="middle">
          TERRACE
        </text>
        <text x="290" y="290" textAnchor="middle">
          BED 02
        </text>
      </g>
      {/* Doors */}
      ...
      <g fontFamily="JetBrains Mono, monospace" fontSize="9" fill="#0B1220">
        ...
        <text x="60" y="346" textAnchor="middle">
          10 FT
        </text>
      </g>
    </svg>
      ...
      >
        <div
          style={{
            ...
            borderRadius: 999,
            boxShadow: '0 0 0 6px rgba(201,164,92,0.25), 0 8px 20px rgba(0,0,0,0.25)',
          }}
        ></div>
      </div>
      <div
