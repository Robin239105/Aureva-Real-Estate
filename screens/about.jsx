    ...
    <div className="page">
      ...
      <section style={{ padding: '140px 0', background: 'var(--ivory)' }}>
        <div className="container-narrow">
          <Reveal>
            <div
              className="eyebrow center underline-gold"
            ...
            >
              "We started Aureva because the houses we loved most were never quite represented as
              they deserved. The work, we felt, was as much editorial as transactional."
            </p>
            <p
              style={{
                textAlign: 'center',
          ...
          <div
            style={{ marginTop: 100, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60 }}
            className="story-grid"
          >
            <Reveal>
              <p style={{ fontSize: 16, lineHeight: 1.85, color: 'var(--charcoal)' }}>
                Aureva began as a single office representing six estates in Beverly Hills. Today we
                are a boutique house of advisors across New York, Los Angeles, Miami, Aspen, and
                London — bound less by geography than by a shared sensibility about what makes a
                residence remarkable.
              </p>
            </Reveal>
            <Reveal delay={120}>
              <p style={{ fontSize: 16, lineHeight: 1.85, color: 'var(--charcoal)' }}>
                We grew slowly on purpose. Senior advisors. Fewer clients. Quiet rooms. Our work is
                measured in trusted introductions, in residences that find their right keeper, and
                in relationships that often outlast the deal itself.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <section style={{ padding: '0 0 140px', background: 'var(--ivory)' }}>
        <div className="container-wide">
          <div
            style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr 1fr', gap: 16, height: 540 }}
            className="img-strip"
          >
            <div className="img-zoom" style={{ marginTop: 60, overflow: 'hidden' }}>
              <div
                className="img-bg"
                style={{ backgroundImage: `url(${IMG.exterior})`, height: '100%' }}
              />
            </div>
        ...
        <div className="container">
          ...
          >
            {[
              [
                'Discretion',
                'We work in confidence. Most of our transactions never reach a public listing.',
              ],
              [
                'Craft',
                'A house is a work of art. We treat its representation with editorial seriousness.',
              ],
              ['Patience', 'We wait for the right house and the right keeper. We never push.'],
              [
                'Counsel',
                "We say no often — to listings, to clients, to deals. That's why our advice can be trusted.",
              ],
              ['Reach', 'Boutique footprint, global network. 38 markets, 12 countries, one team.'],
              [
                'Stewardship',
                'We help you acquire well. We also help you sell well, when the time comes.',
              ],
            ].map(([t, d], i) => (
              <Reveal key={t} delay={i * 60}>
                <div style={{ borderTop: '1px solid rgba(201,164,92,0.4)', paddingTop: 24 }}>
                  <div
                    className="serif"
                    style={{ fontSize: 24, color: 'var(--gold)', fontWeight: 400 }}
                  >
                    0{i + 1}
                  </div>
                  <h3
      ...
      <section style={{ padding: '100px 0 120px', background: '#fff' }}>
        <div className="container">
          <SectionHead
            ...
            action={
              <button onClick={() => navigate('agents')} className="btn btn-outline-navy">
                All advisors <span className="arrow"></span>
              </button>
            }
          />
          <div
