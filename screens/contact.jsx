        ...
        <div className="container">
          ...
          >
            <div>
              ...
              >
                Tell us a little about what you're hoping to do. Within one business day, one of our
                senior advisors with the right specialty will reach out personally.
              </p>

              <div style={{ marginTop: 50, display: 'grid', gap: 26 }}>
                {[
                  { icon: <Icon.Phone />, label: 'Call', value: '+1 (212) 555 0100' },
                  { icon: <Icon.Mail />, label: 'Email', value: 'concierge@aurevarealestate.vercel.app' },
                  { icon: <Icon.Pin />, label: 'New York', value: '455 Madison Avenue, Floor 23' },
                  {
                    icon: <Icon.Pin />,
                    label: 'Los Angeles',
                    value: '9200 Sunset Boulevard, Suite 800',
                  },
                ].map((o) => (
                  <div key={o.label} style={{ display: 'flex', gap: 18, alignItems: 'flex-start' }}>
                    ...
                    <div>
                      ...
                      <div
                        className="serif"
                        style={{ fontSize: 20, color: 'var(--navy)', fontWeight: 500 }}
                      >
                        {o.value}
                      </div>
                    </div>
            ...
            <div style={{ background: '#fff', border: '1px solid var(--line)', padding: 48 }}>
              {submitted ? (
                <div style={{ textAlign: 'center', padding: '80px 20px' }}>
                  ...
                  >
                    Thank you, {form.name.split(' ')[0] || 'we'}.
                  </h3>
                  <p
                    style={{
                      fontSize: 16,
                  ...
                  >
                    Your message is on its way to an advisor. Expect a personal response within one
                    business day.
                  </p>
                  <button
                ...
                >
                  ...
                  <Field label="Tell us more">
                    <textarea
                      ...
                      placeholder="A few words about what you're looking for — location, price range, timing…"
                    />
                  </Field>
                  ...
                  >
                    ...
                    Your message is treated with full confidentiality. Aureva never shares your
                    contact information.
                  </div>
