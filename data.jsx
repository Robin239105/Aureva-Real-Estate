...
const IMG = {
  ...
  heroCity:
    'https://images.unsplash.com/photo-1582407947304-fd86f028f716?auto=format&fit=crop&w=2200&q=85',
  modernApt:
  ...
  estate:
    'https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?auto=format&fit=crop&w=1400&q=85',
  duplex:
  ...
  aspen:
    'https://images.unsplash.com/photo-1551524559-8af4e6624178?auto=format&fit=crop&w=1200&q=85',
  miami:
    'https://images.unsplash.com/photo-1535498730771-e735b998cd64?auto=format&fit=crop&w=1200&q=85',
  hamptons:
  ...
  agent1:
    'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=640&q=85',
  agent2:
    'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=640&q=85',
  agent3:
    'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=640&q=85',
  agent4:
    'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=640&q=85',
  agent5:
    'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=640&q=85',
  agent6:
    'https://images.unsplash.com/photo-1463453091185-61582044d556?auto=format&fit=crop&w=640&q=85',
  // blog
  blog1:
...
const PROPERTIES = [
  {
    ...
    description:
      'A sculpted hillside estate carved into the Beverly canyons. Floor-to-ceiling glazing frames the cityscape; cantilevered terraces invite the sky inside.',
    amenities: [
      'Infinity pool',
      'Wine cellar',
      'Home cinema',
  ...
  },
  {
    ...
    description:
      'Full-floor sky residence with 360° city views, private elevator, and 1,800 sq ft of wraparound terrace.',
    amenities: [
      'Private elevator',
      'Wraparound terrace',
      'Concierge',
  ...
  {
    id: 'p03',
    title: 'Ocean House Malibu',
    price: 18900000,
    rent: false,
    location: 'Malibu Colony, CA',
    type: 'Beachfront',
    status: 'For Sale',
    beds: 5,
    baths: 6,
    ...
    description:
      'Direct beachfront residence on the Malibu Colony, designed by Ricardo Aguilar. Walls of glass open to a private cove.',
    amenities: [
  ...
  },
  {
    ...
    description:
      'Alpine estate on 4.2 acres bordering Maroon Bells. Reclaimed timber, hand-cut stone, ski-in/ski-out access.',
  ...
  },
  {
    ...
    description:
      'Cast-iron landmark loft with 14-ft ceilings, original oak floors, fully renovated by Workstead.',
  ...
  },
  {
    ...
    description:
      'Pre-war duplex on Park Avenue with private elevator vestibule. Fully furnished, white-glove service.',
  ...
  },
  {
    ...
    description:
      'Shingled cottage on a hedge-lined acre, walking distance to Main Beach. Renovated 2024.',
...
const AGENTS = [
  {
    id: 'a1',
    name: 'Eleanor Voss',
    title: 'Managing Director, West Coast',
    image: IMG.agent1,
    listings: 38,
    sold: 240,
    bio: "Eleanor leads Aureva's West Coast division, specializing in trophy estates from Beverly Hills to Montecito.",
    phone: '+1 (310) 555 0142',
    email: 'eleanor@aurevarealestate.vercel.app',
  ...
  },
  {
    id: 'a2',
    name: 'James Kowalski',
    title: 'Director, Manhattan',
    image: IMG.agent2,
    listings: 24,
    sold: 187,
    bio: "Twelve years with Manhattan's most discerning buyers and sellers. Pre-war specialist.",
    phone: '+1 (212) 555 0118',
    email: 'james@aurevarealestate.vercel.app',
  ...
  },
  {
    id: 'a3',
    name: 'Aisha Renard',
    title: 'Senior Advisor, Coastal',
    image: IMG.agent3,
    listings: 31,
    sold: 152,
    bio: 'Aisha represents oceanfront and resort properties across Malibu, Maui, and the Caribbean.',
    phone: '+1 (310) 555 0193',
    email: 'aisha@aurevarealestate.vercel.app',
  ...
  },
  {
    ...
    title: 'Director, Mountain Resort',
    image: IMG.agent4,
    listings: 19,
    sold: 96,
    bio: 'Henrik covers Aspen, Vail, and Park City — alpine estates and ski-in/ski-out residences.',
    phone: '+1 (970) 555 0167',
    email: 'henrik@aurevarealestate.vercel.app',
    langs: ['English', 'Swedish', 'German'],
    rating: 4.9,
  },
  {
    id: 'a5',
    name: 'Marisol Cruz',
    title: 'Senior Advisor, South Florida',
    image: IMG.agent5,
    listings: 28,
    sold: 134,
    bio: 'Marisol specializes in Miami, Palm Beach, and the Florida Keys — waterfront and new development.',
    phone: '+1 (305) 555 0124',
    email: 'marisol@aurevarealestate.vercel.app',
  ...
  },
  {
    ...
    listings: 22,
    sold: 71,
    bio: 'Theo bridges international clients into the U.S. market, with offices in Seoul and London.',
    phone: '+1 (646) 555 0181',
    email: 'theo@aurevarealestate.vercel.app',
    langs: ['English', 'Korean', 'Mandarin'],
    rating: 4.7,
  },
];
...
const TESTIMONIALS = [
  {
    quote:
      'Aureva turned a daunting cross-country move into something effortless. Eleanor understood exactly what we wanted before we did.',
    name: 'Olivia & Marcus Chen',
    role: 'Bought in Beverly Hills',
    img: null,
  },
  {
    quote:
      'Listed on Tuesday, sold above ask by Friday. The marketing was museum-quality — every detail considered.',
    name: 'Patricia Larson',
    role: 'Sold a Tribeca penthouse',
    img: null,
  },
  {
    quote:
      "I've worked with the biggest names in the business. Aureva is in a class of its own — discreet, sophisticated, results.",
    name: 'Dr. Anand Mehta',
...
const BLOG_POSTS = [
  {
    id: 'b1',
    title: 'The 2026 Luxury Market Report',
    excerpt: "Where the world's wealthiest are buying — and why coastal markets are bifurcating.",
  ...
  {
    id: 'b2',
    title: 'Inside a Hillside Renovation',
    excerpt: 'How architect Ada Tolla reimagined a 1960s Trousdale ranch for a modern collector.',
  ...
  {
    id: 'b3',
    title: 'Buying Off-Market: A Quiet Guide',
    excerpt: 'The pocket-listing playbook — when discretion matters more than exposure.',
  ...
  {
    id: 'b4',
    title: 'Aspen After Mud Season',
    excerpt: "The shoulder months are the smartest time to tour mountain trophy homes. Here's why.",
